...
/**
 * Provided mock data — simulates the raw API response shape.
 * This data has been migrated to the FastAPI backend (backend/app/data.py).
 * The service uses this local copy so the UI challenge remains self-contained,
 * but a full-stack candidate should wire the service to call GET /api/jobs instead.
